...
DATABASE_URL="mysql://root:@127.0.0.1:3306/evenements?serverVersion=8.0.32&charset=utf8mb4"
```
...
```php
###> Local database secret
DATABASE_URL="mysql://evenements_user:mot_de_passe_solide@localhost:3306/evenements?serverVersion=8.0.32&charset=utf8mb4"
```

Replace ```evenements_user:mot_de_passe_solide``` with your credentials.
